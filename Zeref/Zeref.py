...
helpMessage ="""҉F҉A҉I҉R҉Y҉ ҉T҉A҉I҉L҉S҉ ҉T҉E҉A҉M҉
Owner : ✰҉B҉[҉E҉]҉Z҉-҉Z҉e҉r҉e҉f҉҉✰
-==================-
◄]·♦·Menu For Public·♦·[►
[•]Adminlist
[•]Ownerlist
...
👑Hanya Untuk Owner👑
-==================-
҉F҉A҉I҉R҉Y҉ ҉T҉A҉I҉L҉S҉ ҉T҉E҉A҉M҉
-==================-
"""
KAC=[cl,ki,kk,kc,ks]

mid = cl.getProfile().mid #Natsu
Amid = ki.getProfile().mid #Lucy
Bmid = kk.getProfile().mid #Erza
Cmid = kc.getProfile().mid #Gray
...
Minat? Silahkan PM!
Idline: http://line.me/ti/p/~wtf00001""",
    "lang":"JP",
...
def bot(op):
          ...
          if wait["Protectgr"] == True:
            if cl.getGroup(op.param1).preventJoinByTicket == False:
              ...
              if op.param2 in admin:
                ...
                try:
                  cl.sendText(op.param1,cl.getContact(op.param2).displayName + "Jangan Buka Kode QR Nyet")
                  cl.kickoutFromGroup(op.param1,[op.param2])
                  X = cl.getGroup(op.param1)
                  X.preventJoinByTicket = True
                  cl.updateGroup(X)
                except:
                  random.choice(KAC).sendText(op.param1,random.choice(KAC).getContact(op.param2).displayName + "Jangan Buka Kode QR Nyet")
    ...
    #--------------- SC Add Admin ---------
            elif "Bokep add @" in msg.text:
              if msg.from_ in owner:
                print "[Command]Staff add executing"
                _name = msg.text.replace("Bokep add @","")
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.append(target)
                            cl.sendText(msg.to,"Bokep Ditambahkan")
                        except:
                            pass
            ...
            elif "Bokep remove @" in msg.text:
              if msg.from_ in owner:
                print "[Command]Staff remove executing"
                _name = msg.text.replace("Bokep remove @","")
                _nametarget = _name.rstrip('  ')
                gs = cl.getGroup(msg.to)
                gs = ki.getGroup(msg.to)
                gs = kk.getGroup(msg.to)
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.remove(target)
                            cl.sendText(msg.to,"Dia Di.Bunuh")
                        except:
                            pass
            ...
            elif msg.text in ["Bokeplist","bokeplist"]:
              if admin == []:
...
#----------------------------------------------------------------------------
   #-------------- Add Friends ------------
            elif "Cuk Add @" in msg.text:
              if msg.toType == 2:
                if msg.from_ in owner:
                  print "[Command]Add executing"
                  _name = msg.text.replace("Cuk Add @","")
                  _nametarget = _name.rstrip('  ')
                  gs = cl.getGroup(msg.to)
                  gs = ki.getGroup(msg.to)
                  gs = kk.getGroup(msg.to)
    ...
    #-----------------=Selesai=------------------
            elif msg.text in ["FT?"]: #Ngirim Semua Kontak Bot
              if msg.from_ in admin:
                msg.contentType = 13
            ...
            elif msg.text in ["Luffy cancel","Bokep cancel"]:
              if msg.from_ in admin:
                if msg.toType == 2:
              ...
              if msg.from_ in admin:
                ...
                if msg.toType == 2:
                    ...
                    ki.updateGroup(X)
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Done Bangsat")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    kk.updateGroup(X)
                    if wait["lang"] == "JP":
                        kk.sendText(msg.to,"Done Bangsat")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    kc.updateGroup(X)
                    if wait["lang"] == "JP":
                        kc.sendText(msg.to,"Done Bangsat")
                    else:
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "Ketik wtf dulu Koplak\nBaru Ketik Sider\nDASAR Kontol ♪")
#-----------------------------------------------
...
#-----------------------------------------------
    ...
    #-------------Fungsi Tag All Start---------------#
            elif msg.text in ["Kiwkiw","kiwkiw"]:
            	 if msg.from_ in admin:
    ...
    #-------------Fungsi Tag All Finish---------------#
        ...
        #-------------Fungsi Spam Start---------------------#
            ...
            elif msg.text == "FT spam link anu":
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to,"Tukang Share On")
                ki.sendText(msg.to,"Tukang Note On")
                kk.sendText(msg.to,"Tukang Nonton On")
                kc.sendText(msg.to,"Tukang Coli On")
                ks.sendText(msg.to,"Tukang Anu Hadir")
                cl.sendText(msg.to,"Semua Udah Hadir Boss\nSiap Protect Group\nAman Gak Aman Yang Penting Ngentot lah")
      ...
      #-------------Fungsi Balesan Respon Finish---------------------#
       ...
       #-------------Fungsi Speedbot Start---------------------#
              ...
              if msg.from_ in admin:
                start = time.time()
                cl.sendText(msg.to, "Sabar Dong ah ah...")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              msg.contentType = 13
              msg.contentMetadata = {'mid': 'u38d55ef45d94951d1f1dff174bc7ed98'}
              cl.sendText(msg.to,"======================")
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
...
#---------------------
          ...
          #random.choice(KAC).sendText(op.param1, "Selamat Datang Di Kamar Kami  " + str(ginfo.name))
          #random.choice(KAC).sendText(op.param1, "Founder Grup Kami " + str(ginfo.name) + " :\n" + ginfo.creator.displayName)
          #random.choice(KAC).sendText(op.param1,"Budayakan Nonton Bokep !!! yah Ka 😊\nSemoga Betah Kk 😘")
    ...
    for zx in range(0,500):
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                ...
                print "Status Sudah di Like Beb"
