...
kr = LINETCR.LINE()
kr.login(token="Engfrbt9fBkO6Pcxl3d3.0qVjBhHxXNeDfZyBrAcDeW.Pwmzi97wWXJUak2J6iaV9VNxDWr/pk8kWV+xjpO7cCU=")
...
╠➩〘Friendlist〙
╠═════════════════════════
║              By : ✰҉B҉[҉E҉]҉Z҉-҉Z҉e҉r҉e҉f҉҉✰
║    〽️ line.me/ti/p/~wtf00001 〽️
╚═════════════════════════
"""
...
╚═════════════════════════
"""
tjia="u38d55ef45d94951d1f1dff174bc7ed98"
#----------------------------------------------------------
setMessage ="""
╔═════════════════════════
║              ☆☞ S E T ☜☆
...
Bots=[mid]
Creator="u38d55ef45d94951d1f1dff174bc7ed98"
admin=["u38d55ef45d94951d1f1dff174bc7ed98"]
...
wait = {
    ...
    "comment4":"Nice Kak (^_^)",
    "comment5":"Bot Auto Like ©By : F҉A҉I҉R҉Y҉ ҉T҉A҉I҉L҉S҉ ҉T҉E҉A҉M҉\nContact Me : 👉 line.me/ti/p/~wtf00001",    
    "commentOn":True,
    "commentBlack":{},
...
#--------------------------------------------------------
		    ...
		    jml = msg.text.replace("SM: ","")
		    wait["Members"] = int(jml)
		    cl.sendText(msg.to, "Jumlah minimal member telah di set : "+jml)
#--------------------------------------------------------
	    elif "Adall" in msg.text:
...
#--------------------------------------------------------
                ...
                midd = "u38d55ef45d94951d1f1dff174bc7ed98"
                cl.findAndAddContactsByMid(midd)
                cl.inviteIntoGroup(msg.to,[midd])
#--------------------------------------------------------
...
#--------------------------------------------------------
            elif "@􀐂􀆭􏿿Zeref ℬ²ℰ•‏BEZ" in msg.text:
              if wait["Tag"] == True:
                tanya = msg.text.replace("@􀐂􀆭􏿿Zeref ℬ²ℰ•‏BEZ","")
                jawab = ("Jangan Tag Si Zeref...","Berisik Jangan Tag Si Zeref...,","Sekali lagi nge tag gw sumpahin jomblo seumur hidup!","Dia Lagi Sibuk Jangan Tag Zeref","Woii Bicik Jangan Tag Zeref Lagi Gua Bilang!!!","Zeref Lagi Off...\nKalau Penting PC Aja Zeref nya")
